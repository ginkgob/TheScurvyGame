...
let functionResult = forTesting(alivePlayers, deadPlayers);

document.getElementById('boxBl2').innerHTML = alivePlayers;
document.getElementById('boxBr2').innerHTML = deadPlayers;
